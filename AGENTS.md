...
- Significant structural changes must update the relevant `AGENTS.md` files.
- If a file or folder becomes difficult to reason about, split it before adding more behavior.
- Prefer creating a new boundary with its own `AGENTS.md` over expanding a god file.
